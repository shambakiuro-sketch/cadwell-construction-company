        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-white p-8 rounded-xl shadow-lg transition-all cursor-pointer group"
            >
              {/* Service image */}
              ...
              <h3 className="text-2xl font-bold text-[#1F3A93] mb-3">
                {service.title}
              </h3>
              ...
              <motion.div
                className="h-1 bg-[#D97E3A] mt-6 rounded-full"
                initial={{ width: 0 }}
